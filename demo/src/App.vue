<template>
  <div class='demo_container'>
    <button v-on:click="toggle_content">Toggle Books</button>
    <section class="comp_sec">
      ...
      <collapse-comp
          heading="My Favorite Colors"
          :css_variables="color_css_variables">
        <div class="collapse_content">
          <ul>
            <li> Red </li>
            <li> Green </li>
  ...
  export default {
    ...
    data() {
      return {
        show_content: false,
        color_css_variables: {
          collapse_comp_content_position: 'absolute',
          collapse_comp_content_z_index: '100'
        }
      };
    },
    components: {
...
<style>
  ...
  .collapse_content::-webkit-scrollbar-track {
    background-color: #F5F5F5;
    border-radius: 10px;
    -webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);
  }
  .collapse_content::-webkit-scrollbar {
    background-color: transparent;
    width: 12px;
    height: 12px;
  }
  .collapse_content::-webkit-scrollbar-thumb {
